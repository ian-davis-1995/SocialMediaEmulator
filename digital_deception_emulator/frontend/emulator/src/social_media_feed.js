  ...
  render() {
    ...
    for (let id in this.state.posts) {
      if (this.state.posts.hasOwnProperty(id)) {
        ...
        console.debug(
          "Showing validation errors: " + this.state.showingEmulatorValidation
        );
      ...
      <div className={"main-container"} id={"mainEmulatorContainer"}>
        ...
        <ModalDialog
          ...
          onDialogClicked={(event) =>
            this.onDialogClicked(this.state.postRepliesToView, event)
          }
          body={
            <FillerQuestion
        ...
        <ModalDialog
          ...
          onBackgroundClicked={() => {}}
          onDialogClicked={(event) =>
            this.onDialogClicked(this.state.postRelpiesToView, event)
          }
          body={
            <FillerQuestion
              id={this.state.modalId}
